...
# to start the ollama container: docker start ollama
...
data = {
    ...
    "prompt": "Write a letter to an contractong company explaining that my air conditioning\
        unit is not functional and asking for a quote to get a new unit or repair the existing unit",
    "stream": False,
}
